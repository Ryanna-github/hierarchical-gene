...
ADMM_trail <- function(aa, tau, lambda_1, lambda_2, lambda_3, q_c_seed, 
                       ...
                       rho_ratio, rho_clip = 4, q_c_matrix_init = NULL,
  ...
  return(list(cdist = cdist, 
              ...
              ci_est_main = ci_est_main,
              ci_est_sub = ci_est_sub,
              q_c_matrix = q_c_matrix,
              coef_full_ori = coef_full_ori_list[[iter]],
              coef_full_ori_comp = coef_full_ori_comp,
              ...
              rho_ratio = rho_ratio,
              pi_est = paste0("(", paste(as.character(round(pi_est,3)), collapse = ","), ")"),
              case_table_full = case_table_full,
